            ...
            <div class="p-4 space-y-3">
                        ...
                        <table class="w-full text-xs">
                            <tbody class="divide-y divide-gray-100">
                                <tr>
                                    ...
                                    <td class="py-2 text-right text-gray-900 font-semibold">Bancolombia</td>
                                </tr>
                                <tr>
                                    <td class="py-2 text-gray-600 font-medium">Tipo de Cuenta</td>
                                    <td class="py-2 text-right text-gray-900 font-semibold">Cuenta Corriente</td>
                                </tr>
                                <tr>
                                    <td class="py-2 text-gray-600 font-medium">Número</td>
                                    <td class="py-2 text-right text-gray-900 font-mono font-semibold">123-456789-00</td>
                                </tr>
                                <tr>
                                    <td class="py-2 text-gray-600 font-medium">Titular</td>
                                    <td class="py-2 text-right text-gray-900 font-semibold">JF Products SAS</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-3">
                        ...
                        <button class="w-full bg-emerald-600 text-white font-medium py-2 px-3 rounded-md hover:bg-emerald-700 transition-colors duration-200 flex items-center justify-center gap-2 text-xs">
                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                            </svg>
                            Pagar con PSE
                        </button>
                        <p class="text-xs text-gray-500 text-center mt-2">Próximamente disponible</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-3">
                        <div class="bg-gray-50 rounded-lg p-3 mb-2 flex justify-center border border-gray-200">
                            <div class="w-28 h-28 bg-white border-2 border-dashed border-gray-300 rounded-md flex items-center justify-center">
                        ...
                        <p class="text-xs text-gray-500 text-center mt-1">Próximamente disponible</p>
                    </div>
                </div>
            </div>
